...
<div class="page">
        <div id="main">
            <form id="MyForm" name="MyForm" action="form.html">
                ...
                <div>
                    <input id="Submit" name="Submit" value="Validate address" type="button" />
                </div>
            </form>
            
            <button onclick="doMystuff();">Create Event</button>
        		  ...
        		  if (status == google.maps.GeocoderStatus.OK) {
					...
					.ajax({
						...
						success : function(res) {
							...
							alert("success");
							document.getElementById("note").innerHTML="Event created";
						}
					});
        		  } 
        		}); 
